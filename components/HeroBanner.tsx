...
export default function HeroBanner({ onOpenVip }: { onOpenVip: () => void }) {
  return (
    <section className="relative overflow-hidden bg-[#121013] text-white">
      ...
      <div
        className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#d47a82]/25 rounded-full blur-3xl pointer-events-none translate-y-1/2 animate-pulse-glow"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
              <a
                href="#catalog"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full bg-[#c5a059] hover:bg-[#d8b56f] text-stone-950 font-bold text-xs sm:text-sm transition-all duration-300 shadow-xl shadow-[#c5a059]/25 hover:scale-[1.04] active:scale-95 cursor-pointer btn-pop btn-shimmer pulse-ring-gold"
              >
                <ShoppingBag className="w-4 h-4 animate-bounce" style={{ animationDuration: '2s' }} />
              ...
              <button
                onClick={onOpenVip}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-white/10 hover:bg-white/20 text-[#f5ebd7] border border-white/20 backdrop-blur-sm font-semibold text-xs sm:text-sm transition-all duration-300 hover:scale-[1.04] active:scale-95 cursor-pointer btn-pop btn-shimmer"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              {/* Main Image Frame */}
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/20 aspect-[3/4] bg-stone-900 group">
                <img
                ...
                <div className="absolute bottom-5 left-5 right-5 p-4 rounded-2xl bg-black/80 backdrop-blur-md border border-white/20 text-white shadow-2xl">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="font-serif text-sm sm:text-base font-semibold truncate text-stone-100 mt-0.5">
                        18K Gold Celestial Jewelry Set
                      </h4>
                    </div>
                    <div className="text-right">
                      <span className="text-[10px] text-stone-400">Price</span>
                      <p className="font-bold text-[#f5ebd7] text-sm sm:text-base">SLE 185.00</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Floating Serum Pill */}
              <div className="absolute -top-6 -left-6 hidden sm:block p-3.5 rounded-2xl bg-stone-900/95 backdrop-blur-md border border-white/25 shadow-2xl max-w-[210px] animate-float z-20">
                <div className="flex items-center gap-3">
                  <img
                    src="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=200&q=80"
                    alt="Serum"
                    className="w-11 h-11 rounded-xl object-cover shadow-md border border-white/10"
                  />
                  <div>
                    <p className="text-[11px] font-bold text-stone-100 leading-tight">24K Radiance Elixir</p>
              ...
              <div className="absolute -bottom-4 -right-4 p-3 px-4.5 rounded-2xl bg-gradient-to-r from-[#c5a059] to-[#dfb872] text-stone-950 font-black text-xs shadow-2xl flex items-center gap-1.5 animate-float-slow z-20">
